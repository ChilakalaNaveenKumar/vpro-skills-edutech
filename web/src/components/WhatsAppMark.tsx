// The WhatsApp glyph sits inside three different buttons in the comp, always at
// 16px and always inheriting the button's colour.
export default function WhatsAppMark({ size = 16 }: { size?: number }) {
  return (
